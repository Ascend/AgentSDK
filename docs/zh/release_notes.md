...
<td class="cellrowborder" valign="top" width="75%" headers="mcps1.1.3.3.1 "><p id="zh-cn_topic_0000001938532254_zh-cn_topic_0000001935094108_p72606219501"><a name="zh-cn_topic_0000001938532254_zh-cn_topic_0000001935094108_p72606219501"></a><a name="zh-cn_topic_0000001938532254_zh-cn_topic_0000001935094108_p72606219501"></a>Beta版本</p>
</td>
</tr>
</tbody>
</table>
...
|------------------|--------------|--------------------------|-----------------------------------|
| Agent SDK 26.0.0 | 不涉及          | <li>CANN 9.0.0及补丁版本</li> | <li>Ascend HDK 26.0.RC1及补丁版本</li> |
...
| 特性名称      | 特性描述                                   | 配套产品型号              |
|-----------|----------------------------------------|---------------------|
| Agent SDK | 支持对Qwen2.5 7B模型进行WebSearcher Agent场景微调 | Atlas 800T A2 训练服务器 |
| Agent SDK | 支持GAIA2数据集的GRPO训练                      | Atlas 800T A2 训练服务器 |
| Agent SDK | 对接Langgraph agent开发前端框架                | Atlas 800T A2 训练服务器 |
| Agent SDK | 支持verl训练后端引擎                           | Atlas 800T A2 训练服务器 |
| Agent SDK | 支持上下文轨迹压缩管理和Step-level RL训练算法          | Atlas 800T A2 训练服务器 |
...
# 26.0.0版本配套文档<a name="ZH-CN_TOPIC_0000002545204931"></a>

| 文档名称                                          | 内容简介                                         | 更新说明                                               |
|-----------------------------------------------|----------------------------------------------|----------------------------------------------------|
| 《[Agent SDK 26.0.0 用户指南](../../README.md)》 | 主要包括Agent SDK的简介、安装部署、快速入门、API接口说明以及其他常用的操作。 | 变更详见《[Agent SDK 26.0.0 用户指南](../../README.md)》。 |
