...
在快速入门Qwen3-32B Math场景前，需修改以下文件，需要修改的参数可以参照文件头的注释。

共卡模式请修改：

1. [共卡配置文件](../../../../aura/configs/train/verl_train_hybrid_A3_t16_qwen3_32b_math_fsdp.yaml)

单步异步分离模式请修改：

1. [单步异步分离配置文件](../../../../aura/configs/train/verl_train_async_A3_t16_qwen3_32b_math_fsdp.yaml)
2. [单步异步分离推理配置](../../../../aura/configs/infer/vllm_infer_i16_qwen3_32b.yaml)

全异步分离模式请修改：

1. [全异步分离配置文件](../../../../aura/configs/train/verl_train_fully_async_A3_t16_qwen3_32b_math_fsdp.yaml)
2. [全异步分离推理配置](../../../../aura/configs/infer/vllm_infer_i16_qwen3_32b.yaml)
