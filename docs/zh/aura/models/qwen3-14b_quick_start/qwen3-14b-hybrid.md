...
```shell
docker pull swr.cn-east-3.myhuaweicloud.com/ascendhub-test/agentsdk:26.2.0-cann9.0.0-torch_npu2.9.0-910b-ubuntu22.04-py3.11
```
...
docker run --name your_container_name \
    ...
    swr.cn-east-3.myhuaweicloud.com/ascendhub-test/agentsdk:26.2.0-cann9.0.0-torch_npu2.9.0-910b-ubuntu22.04-py3.11  \
    sleep infinity
```
