...
**Agent Qwen3-4B Math场景一键拉起样例请参考[使用指南](models/qwen3-4b.md)**

**Agent Qwen3-8B Math 场景一键拉起样例请参考[使用指南](models/qwen3_8b.md)**

**Agent Qwen3-30b-A3B Math场景一键拉起样例请参考[使用指南](models/qwen3-30b-a3b.md)**

**Agent Qwen3-32B Math 场景一键拉起样例请参考[使用指南](models/qwen3_32b.md)**
