...
class TestExecutorManager:
    ...
    def setup_method(self):
        ...
        self.mock_ray.__path__ = []  # Make ray look like a package
        ...
        mock_actor = types.ModuleType("ray.actor")
        mock_actor.ActorHandle = ActorHandle
        ...
        self.patcher = patch.dict('sys.modules', {
            ...
            'ray.dag': MagicMock(),
            'ray.dag.compiled_dag_node': MagicMock(),
            'ray.experimental': MagicMock(),
            'ray.experimental.channel': MagicMock(),
            'ray.experimental.channel.auto_transport_type': MagicMock(),
            'ray.experimental.channel.cached_channel': MagicMock(),
            'ray.experimental.channel.common': MagicMock(),
            'ray.experimental.channel.communicator': MagicMock(),
            'ray._private': MagicMock(),
            'ray._private.worker': MagicMock(),
            'ray._private.client_mode_hook': MagicMock(),
        })
        self.patcher.start()
        ...
        sys.modules["ray"].shutdown = MagicMock()
        sys.modules["ray._private.worker"].shutdown = MagicMock()
        sys.modules["ray._private.client_mode_hook"].wrapper = lambda f: f
        sys.modules["ray.dag.compiled_dag_node"]._shutdown_all_compiled_dags = MagicMock()
