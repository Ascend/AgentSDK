...
class BaseInferServer:
    ...
    async def launch_server(self, *args, **kwargs):
        logger.info("BaseInferServer launch")

    async def wake_up(self, *args, **kwargs):
        logger.info("BaseInferServer wake_up")

    async def sleep(self, *args, **kwargs):
        logger.info("BaseInferServer sleep")
    ...
    async def collective_rpc(
        ...
        logger.info("BaseInferServer collective_rpc")

    async def reset_prefix_cache(self):
        logger.info("BaseInferServer reset_prefix_cache")
