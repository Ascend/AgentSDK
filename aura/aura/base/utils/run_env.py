...
ROOT_PATH = CURRENT_PATH[: CURRENT_PATH.find("/aura/base/utils")]
...
CONFIGS_PATH = ROOT_PATH + "/configs/train/msrl_conf"


def get_thirty_path():
    run_env = {
        "env_vars": {
            "PYTHONPATH": f"{MINDSPEED_RL_PATH}:{MINDSPEED_PATH}:{MINDSPEED_LLM_PATH}:{MEGATRON_PATH}:"
