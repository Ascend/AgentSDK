IMAGE_NAME="aura:1.0.0"
IMAGE_NAME_TMP="aura:1.0.0.temp"
DOCKER_NAME_TMP="aura_tmp"
...
# The following commands are executed manually inside the container (need to be installed in an interactive shell environment)
# cd /home
# bash install_vllm_mindspeed.sh
# exit # Exit to automatically execute subsequent operations
