...
LOCAL_HOSTS=($(ifconfig ${DEFAULT_SOCKET_IFNAME} | awk '/inet /{print $2}'))

echo "LOCAL_HOSTS=${LOCAL_HOSTS[*]} THIS_POD_IP=${THIS_POD_IP} NPUS_PER_NODE=${NPUS_PER_NODE}"
echo "PREFILL_DEVICE_CNT=${PREFILL_DEVICE_CNT} DECODE_DEVICE_CNT=${DECODE_DEVICE_CNT}"
