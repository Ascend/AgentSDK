...
export ENABLE_PREFIX_CACHING=$(python3 ${scripts_dir}/base/get_yaml.py ${CONFIG_FILE} enable_prefix_caching)
...
log_info "ENABLE_PREFIX_CACHING: ${ENABLE_PREFIX_CACHING:-default}"
