...
The following open source software is used in clawcodex-ascend. The copyright
notices and license texts are provided below.
...
License text: See `LICENSES/Hermes-Agent-MIT.txt`.
