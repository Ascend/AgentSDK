...
class TestDedupPluginMcpServers:
    def test_no_duplicates(self) -> None:
        plugin_servers = {"p1": ScopedMcpServerConfig(config=McpStdioServerConfig(command="a"), scope="project")}
        manual_servers = {"m1": ScopedMcpServerConfig(config=McpStdioServerConfig(command="b"), scope="user")}
