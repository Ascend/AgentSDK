...
class TestXaaHelpers:
    ...
    def test_normalize_url_strips_default_https_port(self):
        assert normalize_url("https://auth.example.com:443/token") == "https://auth.example.com/token"

    def test_normalize_url_keeps_non_default_port(self):
        assert normalize_url("https://auth.example.com:8443/token") == "https://auth.example.com:8443/token"
