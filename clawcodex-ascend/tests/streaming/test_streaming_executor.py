...
class TestSyntheticErrors:
    def test_sibling_error_message(self):
        ...
        executor = StreamingToolExecutor(tools, None, ctx)
        executor._errored_tool_description = "Bash(ls)"
        msg = executor._create_synthetic_error_message("tu_1", "sibling_error", _make_assistant_msg())
    ...
    def test_user_interrupted_message(self):
        ...
        ctx = _make_context(tools)
        executor = StreamingToolExecutor(tools, None, ctx)
        msg = executor._create_synthetic_error_message("tu_1", "user_interrupted", _make_assistant_msg())
        assert msg is not None
    ...
    def test_streaming_fallback_message(self):
        ...
        ctx = _make_context(tools)
        executor = StreamingToolExecutor(tools, None, ctx)
        msg = executor._create_synthetic_error_message("tu_1", "streaming_fallback", _make_assistant_msg())
        assert msg is not None
