...
class TestIsAdvisorBlock(unittest.TestCase):
    ...
    def test_advisor_server_tool_use_detected(self) -> None:
        self.assertTrue(is_advisor_block({"type": "server_tool_use", "name": "advisor", "id": "srv_1"}))
    ...
    def test_non_advisor_server_tool_use_rejected(self) -> None:
        ...
        self.assertFalse(is_advisor_block({"type": "server_tool_use", "name": "web_search", "id": "srv_2"}))
