...
from src.tool_system.tools.task_stop import TaskStopTool  # noqa: E402
...
def test_unknown_task_id_returns_error_not_global_stop(ctx: ToolContext) -> None:
    ...
    assert getattr(ctx, "stop_requested", False) is False, "TaskStop must never set stop_requested for an unknown id"
