...
class TestCreateImageMetadataText(unittest.TestCase):
    ...
    def test_returns_none_when_unresized_and_no_source(self) -> None:
        dims = ImageDimensions(original_width=100, original_height=100, display_width=100, display_height=100)
    ...
    def test_resized_with_source_includes_display_and_scale(self) -> None:
        dims = ImageDimensions(original_width=4000, original_height=3000, display_width=1568, display_height=1176)
