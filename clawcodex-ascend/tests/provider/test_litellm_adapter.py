...
class TestChatCompletion:
    def test_chat_passes_external_api_parameters(self, monkeypatch):
        ...
        monkeypatch.setattr("clawcodex_ext.providers._litellm_adapter._load_litellm", lambda: fake_litellm)
    ...
    def test_chat_converts_tools_and_tool_calls(self, monkeypatch):
        ...
        assert response.tool_uses == [{"id": "call_1", "name": "Read", "input": {"file_path": "README.md"}}]
...
class TestBackwardCompatibility:
    ...
    def test_missing_litellm_dependency_raises_clear_error(self, monkeypatch):
        monkeypatch.setattr("clawcodex_ext.providers._litellm_adapter.is_litellm_available", lambda: False)
