...
def test_agent_loop_propagates_cancel_set_via_tool_context(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_agent_loop_does_not_swallow_abort_error_as_tool_error(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
