...
class FakeApiClient:
    ...
    async def send_permission_response_event(self, sid: str, event: dict[str, Any], tok: str) -> None:
...
class FakeSessionHandle:
    ...
    def __init__(self, session_id: str, access_token: str) -> None:
        ...
        self._done_future: asyncio.Future[SessionDoneStatus] = asyncio.get_event_loop().create_future()
