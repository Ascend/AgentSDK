...
class TestQueryEngine(unittest.TestCase):
    ...
    def test_submit_message_retries_transient_upstream_not_found_404(self):
        provider = MagicMock()
    ...
    def test_image_unsupported_error_does_not_recur_on_next_submit(self):
        ...
        result = _run(run())
        self.assertIn("Here is your blog app plan...", result, "second turn must succeed after image strip")
