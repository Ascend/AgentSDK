        ...
        messages = [
            {
                ...
                "content": [
                    {
                        "type": "document",
                        "source": {"type": "url", "url": "http://example.com/doc.pdf"},
                    },
                ],
            }
        ]
                ...
                "content": [
                    {
                        "type": "tool_result",
                        "tool_use_id": "tool1",
                        "content": "Content of a.txt is 1000 lines long...",
                    },
                ],
            },
            {
                ...
                "content": [
                    {
                        "type": "tool_result",
                        "tool_use_id": "tool2",
                        "content": "Content of b.txt is 500 lines...",
                    },
                ],
            },
        ]
                ...
                "content": [
                    {
                        "type": "tool_result",
                        "tool_use_id": "tool2",
                        "content": "More old large content...",
                    },
                ],
            },
            {
                ...
                "content": [
                    {
                        ...
                        "id": "tool1",
                        "name": "Write",
                        "input": {"file_path": "a.txt", "content": "x" * 100},
                    },
                ],
            },
            {
                ...
                "content": [
                    {
                        "type": "tool_result",
                        "tool_use_id": "tool2",
                        "content": "Not compactable result",
                    },
                ],
            },
        ]
