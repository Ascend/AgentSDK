...
class TestShouldExcludeFromPostCompactRestore(unittest.TestCase):
    ...
    def test_memory_path_excluded(self):
        ...
        self.assertTrue(_should_exclude_from_post_compact_restore("/home/user/.claude/memory.md", memory_paths=paths))
...
class TestCreatePostCompactFileAttachments(unittest.TestCase):
    ...
    def test_respects_max_files(self):
        ...
        try:
            ...
            state = {name: {"content": f"file {i}", "timestamp": time.time() + i} for i, name in enumerate(files)}
