...
def test_shutdown_request_envelope_shape() -> None:
    msg = create_shutdown_request_message(request_id="req-1", from_="leader", reason="end of session")
...
def test_shutdown_rejected_envelope_shape() -> None:
    msg = create_shutdown_rejected_message(request_id="req-1", from_="bob", reason="finishing migration")
