...
def test_resolve_uses_default_dir_when_search_dir_is_none(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_resolve_falls_back_to_default_for_unknown_name(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
