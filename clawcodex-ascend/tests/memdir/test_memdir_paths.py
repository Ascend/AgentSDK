...
class HasAutoMemPathOverrideTest(unittest.TestCase):
    ...
    def test_null_byte_rejected(self):
        ...
        # directly from the implementation module. The ``src`` facade
        # intentionally exports only the public memdir API.
        from clawcodex_ext.memdir.paths import _validate_memory_path
