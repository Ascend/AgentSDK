...
Mirrors the architecture described in ``docs/FEATURE_PLAN.md``.
...
CREATE_AGENT_INPUT_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        "name": {
            "type": "string",
            "description": (
                "Unique name for the new tool (kebab-case, lowercase, letters/numbers/hyphens/underscores only)."
            ),
        },
        "description": {
            "type": "string",
        ...
        "input_schema": {
            "type": "object",
            "description": (
                "JSON Schema describing the tool's parameters. Must include 'type', 'properties', and 'required'."
            ),
        },
        "call_type": {
            "type": "string",
