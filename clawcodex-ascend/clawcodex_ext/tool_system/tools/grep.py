...
from clawcodex_ext.utils.abort_controller import AbortError, AbortSignal
...
def _grep_fallback_python(
    ...
    *,
    ...
    if glob_pattern:
        ...
        files_to_search = [p for p in files_to_search if any(_matches_glob(p, pat) for pat in patterns)]
    if type_name:
