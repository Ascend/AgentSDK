...
from clawcodex_ext.types.content_blocks import TextBlock, ToolResultBlock
...
def build_forked_messages(
    ...
    user_msg = create_user_message(content=[*tool_result_blocks, TextBlock(text=build_child_message(directive))])
