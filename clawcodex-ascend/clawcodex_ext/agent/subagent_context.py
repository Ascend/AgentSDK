...
from clawcodex_ext.utils.abort_controller import (
    AbortController,
...
def create_subagent_context(
    ...
    permission_handler = parent_context.permission_handler if overrides.share_permission_handler else None

    # --- Set response length ---
    set_response_length = parent_context.set_response_length if overrides.share_set_response_length else None
