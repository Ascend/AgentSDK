...
def _security_review_private_prompt(args: str, context: CommandContext) -> list[dict[str, Any]]:
    ...
    allowed_tools = parse_slash_command_tools_from_frontmatter(parsed.frontmatter.get("allowed-tools"))
    ...
    executor = make_bash_shell_executor(tool_context, allowed_tools, slash_command_name="security-review")
