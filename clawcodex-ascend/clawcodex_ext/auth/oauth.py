...
DEFAULT_TOKEN_URL = "https://console.anthropic.com/oauth/token"  # nosec B105
...
class OAuthFlow:
        ...
        class CallbackHandler(http.server.BaseHTTPRequestHandler):
            def do_GET(self) -> None:  # pylint: disable=invalid-name
                ...
                if "code" in params:
                    ...
                    self.end_headers()
                    self.wfile.write(
                        b"<html><body><h2>Authorization successful!</h2><p>You can close this window.</p></body></html>"
                    )
                else:
                    self.send_response(400)
                    self.end_headers()

            def log_message(self, format: str, *args: Any) -> None:  # pylint: disable=arguments-differ,redefined-builtin
    ...
    def exchange_code(self, code: str) -> OAuthTokens | None:
        ...
        try:
            import urllib.request  # pylint: disable=redefined-outer-name
