...
CODEX_OAUTH_TOKEN_URL = "https://auth.openai.com/oauth/token"  # nosec B105
CODEX_DEVICE_USER_CODE_URL = "https://auth.openai.com/api/accounts/deviceauth/usercode"
CODEX_DEVICE_TOKEN_URL = "https://auth.openai.com/api/accounts/deviceauth/token"  # nosec B105
