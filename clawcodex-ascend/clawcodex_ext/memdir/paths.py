...
def is_auto_memory_enabled() -> bool:
    ...
    if _is_env_truthy(os.environ.get("CLAUDE_CODE_SIMPLE")):
        return False
    if _is_env_truthy(os.environ.get("CLAUDE_CODE_REMOTE")) and not os.environ.get("CLAUDE_CODE_REMOTE_MEMORY_DIR"):
        return False
    ...
    try:
        ...
        logger.debug("Unable to load auto-memory setting; defaulting enabled", exc_info=True)
    return True
