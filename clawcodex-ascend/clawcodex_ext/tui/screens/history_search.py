...
class HistorySearchScreen(DialogScreen[str | None]):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self._entries = [e if isinstance(e, HistoryEntry) else HistoryEntry(prompt=str(e)) for e in entries]
    ...
    def _update_count_label(self) -> None:
        ...
        self._count_label.update(Text(f"  {shown} / {total} match{'es' if shown != 1 else ''}", style="dim"))
