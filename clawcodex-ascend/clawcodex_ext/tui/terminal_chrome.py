...
def _is_kitty() -> bool:
    return os.environ.get("TERM", "").startswith("xterm-kitty") or bool(os.environ.get("KITTY_WINDOW_ID"))
...
def _write(seq: str) -> None:
    ...
    try:
        ...
        pass  # Terminal escape sequences are optional on unsupported output streams.
