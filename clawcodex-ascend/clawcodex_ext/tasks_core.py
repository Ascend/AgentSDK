...
def create_task_state_base(
    *,
    # Field names mirror TaskStateBase verbatim — call sites construct
    # by keyword (WI-1.1), so the builtin-shadowing names are deliberate.
    id: str,  # pylint: disable=redefined-builtin
    type: TaskType,  # pylint: disable=redefined-builtin
    description: str,
    output_file: str,
    tool_use_id: str | None = None,
