    ...
    def __init__(
        ...
        *,
        ...
        if not _HAS_PROMPT_TOOLKIT:
            raise RuntimeError(
                "prompt_toolkit is required for LiveStatus; install it or fall back to console.status",
            )
            ...
            try:
                ...
                if on_submit is not None:
                    ...
                    if repl is not None and hasattr(repl, "_permission_mode"):
                        ...
                        is_bypass_available = getattr(repl, "_is_bypass_permissions_mode_available", False)
                        ...
                        if repl.tool_context is not None:
                            ...
                            if next_mode == "bypassPermissions":
                                ...
                                repl.tool_context.permission_handler = repl._handle_permission_ask_request
