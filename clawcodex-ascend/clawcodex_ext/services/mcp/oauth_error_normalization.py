...
_VENDOR_TO_RFC_CODE: dict[str, str] = {
    "invalid_refresh_token": "invalid_grant",  # nosec B105 - RFC 6749 error code, not a password
    "expired_refresh_token": "invalid_grant",  # nosec B105 - RFC 6749 error code, not a password
    "token_expired": "invalid_grant",  # nosec B105 - RFC 6749 error code, not a password
}


def normalize_oauth_error_body(status_code: int, body: dict[str, Any]) -> tuple[int, dict[str, Any]]:
