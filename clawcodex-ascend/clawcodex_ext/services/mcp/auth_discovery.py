...
def _lazy_auth_utils():
    ...
    if _mcp_auth_utils is None:
        from mcp.client.auth.utils import (  # pylint: disable=no-name-in-module
    ...
    *,
    ...
    try:
        ...
        if escape_hatch_url:
            ...
            if escape_hatch_source_scope is not None and escape_hatch_source_scope not in _ESCAPE_HATCH_TRUSTED_SCOPES:
                logger.warning(
