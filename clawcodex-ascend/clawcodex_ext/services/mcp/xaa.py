...
TOKEN_EXCHANGE_GRANT = "urn:ietf:params:oauth:grant-type:token-exchange"  # nosec B105 - RFC 8693 URN, not a password
JWT_BEARER_GRANT = "urn:ietf:params:oauth:grant-type:jwt-bearer"

ID_JAG_TOKEN_TYPE = "urn:ietf:params:oauth:token-type:id-jag"  # nosec B105 - token-type URN, not a password
ID_TOKEN_TYPE = "urn:ietf:params:oauth:token-type:id_token"  # nosec B105 - token-type URN, not a password
