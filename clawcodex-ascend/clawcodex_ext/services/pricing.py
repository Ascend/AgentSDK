...
def _get_exact_pricing(
    ...
    *,
    ...
    if service_tier == "priority":
        return _TIER_MINIMAX_M3_PRIORITY_LONG if is_long_context else _TIER_MINIMAX_M3_PRIORITY
    return _TIER_MINIMAX_M3_STANDARD_LONG if is_long_context else _TIER_MINIMAX_M3_STANDARD
