...
from clawcodex_ext.tasks_core import is_terminal_task_status  # pylint: disable=no-name-in-module
        ...
        * Name bound to a different agent_id whose task is **terminal**
        ...
        with self._lock:
            ...
            if existing is not None:
                ...
                if existing_state is not None and not is_terminal_task_status(existing_state.status):
