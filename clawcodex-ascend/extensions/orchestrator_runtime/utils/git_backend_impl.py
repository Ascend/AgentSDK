...
Deliberate copy so git helpers work without importing clawcodex_ext.
When orchestrator switches to the Protocol-based ``GitBackend``, this
file may diverge from ``clawcodex_ext/utils/git.py``.
"""
