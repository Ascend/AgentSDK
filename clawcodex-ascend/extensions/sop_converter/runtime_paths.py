...
# Backward-compatibility stub — re-exports from core/runtime_paths.py
from extensions.sop_converter.core.runtime_paths import (
    is_wsl_runtime,
...
from extensions.sop_converter.core import runtime_paths as _impl
