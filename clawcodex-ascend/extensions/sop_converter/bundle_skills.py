...
# Backward-compatibility stub — re-exports from runtime/bundle_skills.py
from extensions.sop_converter.runtime.bundle_skills import (
    logger,
...
from extensions.sop_converter.runtime import bundle_skills as _impl
